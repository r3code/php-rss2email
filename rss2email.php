...
$db_file = 'db_rss_sent_state.json';
$recepients_list_file = 'rss_recepients_list.json';
...
function isFeedEntrySent($entryId, $recepient)
{
	...
	if ( !file_exists($db_file) ) 
		throw new FileReadError("Couldn't open feeds DB file $db_file");
...
function setFeedEntrySent($entryId, $recepient) 
{
	...
	//DEBUG: echo "<b>IN FILE: $file_text</b><br>";
